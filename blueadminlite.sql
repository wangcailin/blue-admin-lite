...
INSERT INTO `blue_admin` VALUES (1,'admin','Admin','075eaec83636846f51c152f29b98a2fd','s4f3','/assets/img/avatar.png','admin@fastadmin.net',0,1519463557,1492186163,1519463557,'79a3385b-04da-45c0-a06c-c4dddb83db4b','normal'),(6,'bloomberg','Nickname','8e18c5008de34e36d21b97678b7f3b98','JirRbB','/assets/img/avatar.png','dreamcailin@hotmail.com',0,1519460901,1519460884,1519463554,'','normal');
...
CREATE TABLE `blue_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=1340 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-02-24 17:31:03
